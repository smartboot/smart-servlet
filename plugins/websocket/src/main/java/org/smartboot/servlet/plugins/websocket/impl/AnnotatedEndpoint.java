...
public class AnnotatedEndpoint extends Endpoint {
    ...
    public void onOpen(Session session, EndpointConfig config) {
        if (Objects.equals(config, smartServerEndpointConfig.getServerEndpointConfig())) {
            Object[] args = getParamValues(smartServerEndpointConfig.getOnOpenMethod(), session, null, null);
    ...
    public void onClose(Session session, CloseReason closeReason) {
        Object[] args = getParamValues(smartServerEndpointConfig.getOnCloseMethod(), session, closeReason, null);
    ...
    public void onError(Session session, Throwable thr) {
        Object[] args = getParamValues(smartServerEndpointConfig.getOnErrorMethod(), session, null, thr);
    ...
    private Object[] getParamValues(Method method, Session session, CloseReason closeReason, Throwable thr) {
        ...
        for (Class<?> paramType : method.getParameterTypes()) {
            ...
            if (pathParam != null) {
                value = uriData.get(pathParam.value());
            }
            args[i++] = value;
        }
